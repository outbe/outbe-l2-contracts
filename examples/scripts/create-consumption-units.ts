...
import { ConsumptionUnitUpgradeable__factory, IConsumptionUnit__factory } from "../contracts";
...
async function main() {
  ...
  // Initialize client
  const cuClient = IConsumptionUnit__factory.connect(CONFIG.CONSUMPTION_UNIT_ADDRESS, craWallet);
